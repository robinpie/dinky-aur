...
1. Set up an AUR account and SSH key.
2. Initialize the AUR git repo:
   ```
   cd /run/media/robin/Robin_s\ Card/codingStuff/dinky-aur-pkg
   git init
   git remote add origin ssh+git://aur@aur.archlinux.org/dinky.git
